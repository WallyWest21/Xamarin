...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Support.V7.Widget.RecyclerView+IOnScrollListenerImplementor, Xamarin.Android.Wearable", RecyclerView_OnScrollListenerImplementor.class, __md_methods);
	}


	public RecyclerView_OnScrollListenerImplementor ()
	{
		super ();
		if (getClass () == RecyclerView_OnScrollListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Support.V7.Widget.RecyclerView+IOnScrollListenerImplementor, Xamarin.Android.Wearable", "", this, new java.lang.Object[] {  });
	}
