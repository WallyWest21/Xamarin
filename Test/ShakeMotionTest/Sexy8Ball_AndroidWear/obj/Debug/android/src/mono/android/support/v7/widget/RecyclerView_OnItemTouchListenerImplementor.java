...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Support.V7.Widget.RecyclerView+IOnItemTouchListenerImplementor, Xamarin.Android.Wearable", RecyclerView_OnItemTouchListenerImplementor.class, __md_methods);
	}
	...
	public RecyclerView_OnItemTouchListenerImplementor ()
	{
		...
		if (getClass () == RecyclerView_OnItemTouchListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Support.V7.Widget.RecyclerView+IOnItemTouchListenerImplementor, Xamarin.Android.Wearable", "", this, new java.lang.Object[] {  });
	}
