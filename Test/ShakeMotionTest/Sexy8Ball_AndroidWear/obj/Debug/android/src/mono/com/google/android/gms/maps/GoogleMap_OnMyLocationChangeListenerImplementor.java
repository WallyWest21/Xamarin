...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Android.Gms.Maps.GoogleMap+IOnMyLocationChangeListenerImplementor, Xamarin.Android.Wearable", GoogleMap_OnMyLocationChangeListenerImplementor.class, __md_methods);
	}
	...
	public GoogleMap_OnMyLocationChangeListenerImplementor ()
	{
		...
		if (getClass () == GoogleMap_OnMyLocationChangeListenerImplementor.class)
			mono.android.TypeManager.Activate ("Android.Gms.Maps.GoogleMap+IOnMyLocationChangeListenerImplementor, Xamarin.Android.Wearable", "", this, new java.lang.Object[] {  });
	}
