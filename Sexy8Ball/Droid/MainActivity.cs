...
namespace Sexy8Ball.Droid
{
	[Activity (Label = "Sexy8Ball.Droid", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
